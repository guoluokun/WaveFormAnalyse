...
This module intentionally does not import Qt. It runs before QApplication is
created so platform-plugin failures can be diagnosed without Qt aborting the
Python process.
"""
...
def choose_qt_platform(
    ...
    """Return ``(platform, explicit)`` without importing Qt."""
    ...
    # Qt5 often defaults to xcb even inside GNOME Wayland / WSLg. Prefer the
    # native Wayland plugin when it is actually present in the PyQt5 install.
